...
def listDirectory(directory, fileExtList):
    "get list of file object for files of particular extensions"
...
if __name__ == "__main__":
    for info in listDirectory("/home/ycx/downloads", [".mp3"]):
        print("\n".join(["%s = %s" % (k, v) for k, v in info.items()]))
