...
class Dialectizer(BaseHTMLProcessor):
    ...
    def handle_data(self, text):
        # override
        # called for every block of text in HTML sorce
        # if in verbati mode save text unaltered;
...
class ChefDialectizer(Dialectizer):
    """
    convert HTML to Serdish Chef-speak
    based on the classic chef.x, copyright (c) 1992,1993 Hohn Hagerman
    """
    subs = ((r'a([nu])', r'u\1'),
            (r'A([nu])', r'U\1'),
            (r'a\B', r'e'),
...
class FuddDialectizer(Dialectizer):
    """
    conver HTML to Elmer Fudd-speak
    """
    subs = ((r'[rl]', r'w'),
            (r'qu', r'qw'),
            (r'th\b', r'f'),
